...
import static br.com.dalessio.auto.category.constants.Constants.Routes.RT_CARD_AUTO_CATEGORY_ROUTE;
...
public class CardController {
	...
	@Autowired
	public CardController(MessageUtils messageUtils) {
		this.messageUtils = messageUtils;
	}

	@PostMapping(RT_CARD_AUTO_CATEGORY_ROUTE)
